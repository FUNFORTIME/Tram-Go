...
namespace LanguageLocalization
{
    ...
    public class Localization_SOURCE_Editor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (l.LoadedLanguageFiles != null && l.LoadedLanguageFiles.Length > 0 && l.selectedLanguage >= 0 && l.selectedLanguage < l.LoadedLanguageFiles.Length)
                PL(l.LoadedLanguageFiles[l.selectedLanguage].name);
